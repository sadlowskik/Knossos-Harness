...
export const api = {
  ...
  addEndpoint:   (body) => request('POST', '/api/endpoints', body),
  testEndpoint:  (id) => request('POST', '/api/endpoints/test', { id }),
  deleteEndpoint:(id) => request('POST', '/api/endpoints/delete', { id }),
